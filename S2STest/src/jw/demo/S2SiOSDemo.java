	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			parser = new CSVParser(
					new FileReader(
							homepath+"/Development/apache-jmeter-2.12/bin/remarketing-i2.txt"),
					format);
		...
		for (CSVRecord record : parser) {
			...
			try {
				uri = new URIBuilder().setScheme("https")
						...
						.setPath("/pagead/conversion/969704640/") // need to change your Conversion ID of AdWords account
